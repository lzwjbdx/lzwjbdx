...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        db.execSQL("create table "+DBUtils.DATABASE_TABLE+"("+DBUtils.NOTEPAD_ID+" integer primary key autoincrement,"+DBUtils.NOTEPAD_CONTENT+
    ...
    public boolean deleteData(String id){
        ...
        return
                sqLiteDatabase.delete(DBUtils.DATABASE_TABLE,null,contentValuesArray)>0;
    }
    public boolean updataData(String id,String content,String userYear){
        ContentValues contentValues=new ContentValues();;
